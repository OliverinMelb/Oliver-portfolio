...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a senior front-end engineer with extensive development experience and an active contributor to open-source projects.{" "}
      </span>
      <span
      ...
      >
        I specialize in building high-performance web applications using modern frontend technologies and AI solutions.
      </span>
    </h1>
  );
